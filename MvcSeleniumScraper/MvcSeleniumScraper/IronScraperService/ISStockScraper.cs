...
using MvcSeleniumScraper.IronScraperService;

namespace MvcSeleniumScraper.IronScraperService
{
    public class ISStockScraper : WebScraper
    {
        List<ISStock> listOfStocks = new List<ISStock>();
        ...
        public void AddStockToDatabase()
        {
            ...
            foreach (var stock in listOfStocks)
            {
                ...
                ISDatabase.InsertStockDataIntoDB(stock);
            }
        }
